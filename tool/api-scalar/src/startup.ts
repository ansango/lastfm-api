 ...
 */
export function failAndExit(_message: string, opts: { exit?: (code: number) => void; color?: boolean } = {}): never {
...
export function validateOrExit(
	opts: { env?: Record<string, string | undefined>; exit?: (code: number) => void; color?: boolean } = {},
