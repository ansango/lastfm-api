...
import * as albumSchemas from '@/api/album/schemas.js'
import * as artistSchemas from '@/api/artist/schemas.js'
import * as authSchemas from '@/api/auth/schemas.js'
import * as chartSchemas from '@/api/chart/schemas.js'
import * as geoSchemas from '@/api/geo/schemas.js'
import * as librarySchemas from '@/api/library/schemas.js'
import * as tagSchemas from '@/api/tag/schemas.js'
import * as trackSchemas from '@/api/track/schemas.js'
import * as userSchemas from '@/api/user/schemas.js'
import { CANONICAL_METHODS } from '@/canonical-methods.js'
import type { LastFmClient } from '@/client.js'
import * as exporterSchemas from '@/modules/exporter/schemas.js'
import * as insightsSchemas from '@/modules/insights/schemas.js'
import * as playlistsSchemas from '@/modules/playlists/schemas.js'
import * as reportsSchemas from '@/modules/reports/schemas.js'
