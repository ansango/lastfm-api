...
const artistCountSchema = z.string().or(z.number()).optional()
const bootstrapSchema = z.string().or(z.number()).optional()
const countrySchema = z.string().optional()
const countSchema = z.string().or(z.number()).optional()
const datePropSchema = z
	.object({
		uts: z.string().or(z.number()),
		'#text': z.string(),
	})
	.optional()
const durationSchema = z.string().or(z.number()).optional()
const fromSchema = z.string().or(z.number()).optional()
const genderSchema = z.string().optional()
const periodSchema = z.enum(['overall', '7day', '1month', '3month', '6month', '12month']).optional()
const playcountSchema = z.string().or(z.number()).optional()
const playlistsSchema = z.string().or(z.number()).optional()
const rankSchema = z.string().or(z.number()).optional()
const realNameSchema = z.string().optional()
const subscriberSchema = z.string().or(z.number()).optional()
const tagNameSchema = z.string().min(1, 'Tag name cannot be empty')
const textSchema = z.string().optional()
const toSchema = z.string().or(z.number()).optional()
const totalPagesSchema = z.string().or(z.number()).optional()
const totalSchema = z.string().or(z.number()).optional()
const trackCountSchema = z.string().or(z.number()).optional()
const trackNameSchema = z.string().min(1, 'Track name cannot be empty')
const typeSchema = z.string().optional()
const unixtimeSchema = z.string().or(z.number()).optional()
