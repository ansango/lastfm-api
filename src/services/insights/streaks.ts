...
/**
 * Formats a UNIX timestamp (seconds) into UTC YYYY-MM-DD.
 */
...
/**
 * Calculates listening streaks (current active streak, longest streak, longest dry spell).
 */
export async function getListeningStreaks(
	...
	// Check current streak from end of series
...
/**
 * Returns a daily listening heatmap with normalized intensity levels (0..4).
 */
export async function getListeningHeatmap(
	...
	// Generate day calendar list for the past `daysCount` days ending today
	const now = new Date()
