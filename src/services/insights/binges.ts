...
import type { InsightsBingesRequest, InsightsBingesResponse } from '../insights.schemas.js'
import { createUserService } from '../user.js'
import { type BingesTrackKey, findBinges, type ScrobbleItem } from './lib/binges.js'
...
export async function getBinges(
	...
	// Recenttracks returns descending order; sort ascending for consecutive streak detection
