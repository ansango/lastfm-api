/**
 * binges.ts — detect binge listening runs from a list of scrobbles.
 *
 * Groups consecutive plays of the same artist or track where the gap
 * between adjacent scrobbles does not exceed maxGapSeconds (default 1h).
 */
