...
import { computeDiversity, topNShare } from '../lib/diversity.js'
...
/**
 * Normalizes an artist from Last.fm getTopArtists payload
 */
...
/**
 * Normalizes a track from Last.fm getTopTracks payload
 */
...
/**
 * Normalizes an album from Last.fm getTopAlbums payload
 */
...
/**
 * Normalizes a tag from Last.fm getTopTags payload
 */
...
/**
 * Fetches and aggregates listening summary for a user over a given period,
 * including Shannon diversity calculations.
 */
